...
# ⬛ High Density Coke (T2)

> [!INFO] Tier 2 fuel
> Cook the residue hard enough and it cracks into near-pure solid carbon.
> Denser than bitumen and standard coke and burns easier.
...
| -------- | ---------------- | -------------------------------------- | ---------- | ---- |
| **Main** | 30 Heavy Residue | 20 High Density Coke + 10 Refinery Gas | Coker Unit | 6 s  |
...
| Input      | Output               | Building   | Time |
| ---------- | -------------------- | ---------- | ---- |
| 30 Bitumen | 15 High Density Coke | Coker Unit | 8 s  |
...
| Input                        | Output               | Building   | Time |
| ---------------------------- | -------------------- | ---------- | ---- |
| 20 Heavy Residue + 15 Diesel | 40 High Density Coke | Coker Unit | 8 s  |
